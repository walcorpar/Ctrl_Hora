...
origins = [
    ...
    "https://ctrl-hora-user-admin.onrender.com",
]
...
# Endpoint to register entry (restricted to non-admins)
@app.post("/entry")
...
# Endpoint to register exit (restricted to non-admins)
@app.post("/exit")
...
if __name__ == "__main__":
    import uvicorn
    port = int(os.getenv("PORT", 8000))  # Usa $PORT o 8000 por defecto
