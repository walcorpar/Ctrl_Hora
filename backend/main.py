...
DB_NAME = os.getenv("DB_NAME", "ctrl_hora") # Usa una variable de entorno para el nombre de la DB
...
origins = [
    "https://ctrl-hora-frontend.onrender.com", # Tu URL de frontend en Render
...
async def login(form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    # Guardar el token para validaciones posteriores (en prod, usaría JWT)
